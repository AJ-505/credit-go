...
export default function Dashboard() {
  return (
    <div className="min-h-screen bg-black text-white p-6 font-sans flex items-center justify-center">
      <div className="bg-black/40 border border-white/10 rounded-xl backdrop-blur-xl shadow-2xl w-full max-w-4xl p-8 md:p-12">
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="md:w-2/3">
            ...
            <div className="mt-10 pt-6 border-t border-black/10 dark:border-white/10 text-right">
               <Link href="/5" className="text-gray-500 hover:opacity-70 font-medium text-sm">Return to Home</Link>
            </div>
          </div>
        </div>
