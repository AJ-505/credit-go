...
export default function RoleSelection() {
  return (
    <div className="min-h-screen bg-black text-white p-6 font-sans">
      <div className="bg-black/40 border border-white/10 rounded-xl backdrop-blur-xl shadow-2xl max-w-3xl mx-auto mt-12 p-8 md:p-12">
        <div className="mb-10">
          <Link href="/5" className="text-gray-500 hover:opacity-70 mb-6 inline-block text-sm font-medium">← Home</Link>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Link href="/5/onboarding/freelancer" className="block h-full">
            <div className="bg-white/[0.02] border-white/5 hover:border-white/20 hover:bg-white/[0.05] rounded-lg p-6 h-full flex flex-col items-center text-center transition-all group">
          ...
          <Link href="/5/onboarding/worker" className="block h-full">
            <div className="bg-white/[0.02] border-white/5 hover:border-white/20 hover:bg-white/[0.05] rounded-lg p-6 h-full flex flex-col items-center text-center transition-all group">
          ...
          <Link href="/5/onboarding/government" className="block h-full">
            <div className="bg-white/[0.02] border-white/5 hover:border-white/20 hover:bg-white/[0.05] rounded-lg p-6 h-full flex flex-col items-center text-center transition-all group">
