      ...
      <div className="bg-black/40 border border-white/10 rounded-xl backdrop-blur-xl shadow-2xl max-w-2xl mx-auto mt-12 p-8 md:p-12">
        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            <input type="text" placeholder="e.g. Graphic Designer" className="bg-transparent border-white/10 focus:border-white/40 text-white rounded-md w-full p-3 border outline-none transition-all" />
          </div>
