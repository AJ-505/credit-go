    ...
    <div className="min-h-screen bg-[#f4f4f0] text-[#111] p-6 font-sans">
      <div className="bg-white border-4 border-[#111] rounded-none shadow-[8px_8px_0px_0px_rgba(17,17,17,1)] max-w-2xl mx-auto mt-12 p-8 md:p-12">
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-bold text-[#111] mb-3">Government Worker Profile</h1>
        ...
        <form className="space-y-6">
          ...
          <div>
            <label className="text-sm font-bold text-[#555] block mb-2">Agency / MDA Name</label>
            <input type="text" placeholder="e.g. Ministry of Finance" className="bg-white border-2 border-[#111] focus:border-[#FF4F00] text-[#111] rounded-none font-mono p-4 w-full p-3 border outline-none transition-all" />
          </div>
          ...
          <div className="border-2 border-dashed border-black/20 dark:border-white/20 rounded-xl p-8 text-center transition-colors cursor-pointer hover:border-emerald-500 bg-transparent">
            ...
            <p className="font-medium text-[#111]">Upload Government ID & Posting Letter</p>
