    ...
    <div className="min-h-screen bg-[#fff9e6] text-[#0f172a] p-6 font-sans">
      <div className="bg-white border-4 border-slate-900 rounded-3xl shadow-[8px_8px_0px_0px_rgba(15,23,42,1)] max-w-2xl mx-auto mt-12 p-8 md:p-12">
        ...
        <form className="space-y-6">
          ...
          <div>
            <label className="text-sm font-bold text-slate-600 block mb-2">Agency / MDA Name</label>
            <input type="text" placeholder="e.g. Ministry of Finance" className="bg-[#f8fafc] border-4 border-slate-200 focus:border-[#8b5cf6] text-slate-900 rounded-xl font-bold p-4 w-full p-3 border outline-none transition-all" />
          </div>
