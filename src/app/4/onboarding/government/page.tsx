    ...
    <div className="min-h-screen bg-black text-white p-6 font-sans">
      <div className="bg-[#111] p-8 max-w-2xl mx-auto mt-12 p-8 md:p-12">
        ...
        <form className="space-y-6">
          ...
          <div>
            <label className="text-sm font-bold text-gray-400 block mb-2">Agency / MDA Name</label>
            <input type="text" placeholder="e.g. Ministry of Finance" className="bg-transparent border-b-2 border-gray-800 focus:border-[#0061FE] text-white text-xl rounded-none w-full p-3 border outline-none transition-all" />
          </div>
