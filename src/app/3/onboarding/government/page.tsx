      ...
      <div className="bg-[#161b22] border border-gray-800 rounded-lg shadow-xl max-w-2xl mx-auto mt-12 p-8 md:p-12">
        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            <input type="text" placeholder="e.g. Ministry of Finance" className="bg-[#0d1117] border-gray-800 focus:border-[#ff7b72] text-white rounded w-full p-3 border outline-none transition-all" />
          </div>
