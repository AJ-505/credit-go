    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white p-6 font-sans">
      <div className="bg-black border border-[#222] rounded-lg shadow-2xl max-w-2xl mx-auto mt-12 p-8 md:p-12">
        ...
        <form className="space-y-6">
          ...
          <div>
            <label className="text-sm font-bold text-[#888] block mb-2">Agency / MDA Name</label>
            <input type="text" placeholder="e.g. Ministry of Finance" className="bg-[#111] border-[#333] focus:border-white text-white rounded-lg font-mono w-full p-3 border outline-none transition-all" />
          </div>
