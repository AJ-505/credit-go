...
export default function Dashboard() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white p-6 font-sans flex items-center justify-center">
      <div className="bg-black border border-[#222] rounded-lg shadow-2xl w-full max-w-4xl p-8 md:p-12">
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="md:w-1/3 text-center border-r border-black/10 dark:border-white/10 pr-0 md:pr-12">
            ...
            <p className="text-[#888] text-sm mb-8">AI-Synthesized Profile</p>
          ...
          <div className="md:w-2/3">
            ...
            <p className="text-[#888] mb-10 leading-relaxed">Your financial footprint has been securely analyzed. By maintaining your positive repayment habits, these limits will automatically scale upward.</p>
            
            <div className="grid sm:grid-cols-2 gap-4 mb-10">
              <div className="p-5 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5">
                <p className="text-[#888] text-xs font-bold uppercase tracking-wider mb-2">Available Capacity</p>
                <p className="text-2xl font-bold text-white">₦250,000</p>
              </div>
              <div className="p-5 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5">
                <p className="text-[#888] text-xs font-bold uppercase tracking-wider mb-2">Current Tier</p>
            ...
            <div className="mt-10 pt-6 border-t border-black/10 dark:border-white/10 text-right">
               <Link href="/2" className="text-[#888] hover:opacity-70 font-medium text-sm">Return to Home</Link>
            </div>
          </div>
        </div>
