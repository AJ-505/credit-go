...
export default function RoleSelection() {
  return (
    <div className="min-h-screen bg-white text-black p-6 font-sans">
      <div className="bg-white border-0 shadow-[0_0_50px_rgba(0,0,0,0.05)] rounded-3xl max-w-3xl mx-auto mt-12 p-8 md:p-12">
        <div className="mb-10">
          <Link href="/10" className="text-gray-500 hover:opacity-70 mb-6 inline-block text-sm font-medium">← Home</Link>
          <h1 className="text-3xl md:text-4xl font-bold text-black mb-3">How do you earn?</h1>
          <p className="text-gray-500">We customize your profiling to ensure the most accurate trust score.</p>
        </div>
        
        <div className="grid gap-4 md:grid-cols-3">
          <Link href="/10/onboarding/freelancer" className="block h-full">
            <div className="bg-[#f5f5f7] border-transparent hover:bg-black hover:text-white rounded-2xl transition-colors duration-300 p-6 h-full flex flex-col items-center text-center transition-all group">
              ...
              <h3 className="font-bold text-black mb-2 text-lg">Freelancer</h3>
              <p className="text-gray-500 text-sm">Independent creator or gig worker</p>
            </div>
          </Link>
          
          <Link href="/10/onboarding/worker" className="block h-full">
            <div className="bg-[#f5f5f7] border-transparent hover:bg-black hover:text-white rounded-2xl transition-colors duration-300 p-6 h-full flex flex-col items-center text-center transition-all group">
              ...
              <h3 className="font-bold text-black mb-2 text-lg">Corporate</h3>
              <p className="text-gray-500 text-sm">Full-time employee at a registered company</p>
            </div>
          </Link>

          <Link href="/10/onboarding/government" className="block h-full">
            <div className="bg-[#f5f5f7] border-transparent hover:bg-black hover:text-white rounded-2xl transition-colors duration-300 p-6 h-full flex flex-col items-center text-center transition-all group">
              ...
              <h3 className="font-bold text-black mb-2 text-lg">Government</h3>
