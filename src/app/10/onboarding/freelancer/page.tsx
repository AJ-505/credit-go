    ...
    <div className="min-h-screen bg-white text-black p-6 font-sans">
      <div className="bg-white border-0 shadow-[0_0_50px_rgba(0,0,0,0.05)] rounded-3xl max-w-2xl mx-auto mt-12 p-8 md:p-12">
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-bold text-black mb-3">Freelancer Profile</h1>
        ...
        <form className="space-y-6">
          ...
          <div>
            <label className="text-sm font-bold text-gray-500 block mb-2">Primary Skill / Profession</label>
            <input type="text" placeholder="e.g. Graphic Designer" className="bg-[#f5f5f7] border-transparent focus:border-black focus:bg-white text-black rounded-2xl px-5 py-4 transition-colors w-full p-3 border outline-none transition-all" />
          </div>
          ...
          <div className="border-2 border-dashed border-black/20 dark:border-white/20 rounded-xl p-8 text-center transition-colors cursor-pointer hover:border-emerald-500 bg-transparent">
            ...
            <p className="font-medium text-black">Upload Utility Bill or Bank Statement</p>
