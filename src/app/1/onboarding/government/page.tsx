    ...
    <div className="min-h-screen bg-[#09090b] text-white p-6 font-sans">
      <div className="bg-[#111113]/90 border border-white/10 rounded-[2rem] shadow-2xl backdrop-blur-xl max-w-2xl mx-auto mt-12 p-8 md:p-12">
        ...
        <form className="space-y-6">
          ...
          <div>
            <label className="text-sm font-bold text-stone-400 block mb-2">Agency / MDA Name</label>
            <input type="text" placeholder="e.g. Ministry of Finance" className="bg-[#1a1a1e] border-white/10 focus:border-red-500/50 text-white rounded-xl w-full p-3 border outline-none transition-all" />
          </div>
