    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 p-6 font-sans">
      <div className="bg-white border border-slate-100 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] max-w-2xl mx-auto mt-12 p-8 md:p-12">
        ...
        <form className="space-y-6">
          ...
          <div>
            <label className="text-sm font-bold text-slate-500 block mb-2">Employer Name</label>
            <input type="text" placeholder="e.g. Paystack" className="bg-slate-50 border-slate-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 text-slate-900 rounded-xl w-full p-3 border outline-none transition-all" />
          </div>
