    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 p-6 font-sans">
      <div className="bg-white border border-slate-100 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] max-w-2xl mx-auto mt-12 p-8 md:p-12">
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-bold text-slate-900 mb-3">Government Worker Profile</h1>
        ...
        <form className="space-y-6">
          ...
          <div>
            <label className="text-sm font-bold text-slate-500 block mb-2">Agency / MDA Name</label>
            <input type="text" placeholder="e.g. Ministry of Finance" className="bg-slate-50 border-slate-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 text-slate-900 rounded-xl w-full p-3 border outline-none transition-all" />
          </div>
          ...
          <div className="border-2 border-dashed border-black/20 dark:border-white/20 rounded-xl p-8 text-center transition-colors cursor-pointer hover:border-emerald-500 bg-transparent">
            ...
            <p className="font-medium text-slate-900">Upload Government ID & Posting Letter</p>
