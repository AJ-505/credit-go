    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 p-6 font-sans">
      <div className="bg-white border border-gray-200 rounded-xl shadow-lg max-w-2xl mx-auto mt-12 p-8 md:p-12">
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-3">Freelancer Profile</h1>
        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            <input type="text" placeholder="e.g. Graphic Designer" className="bg-white border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 text-gray-900 rounded-md shadow-sm w-full p-3 border outline-none transition-all" />
          </div>
          ...
          <div className="border-2 border-dashed border-black/20 dark:border-white/20 rounded-xl p-8 text-center transition-colors cursor-pointer hover:border-emerald-500 bg-transparent">
            ...
            <p className="font-medium text-gray-900">Upload Utility Bill or Bank Statement</p>
